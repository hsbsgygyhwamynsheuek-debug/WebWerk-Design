...
❌ No #[ignore] on tests without explicit follow-up in task docs
...
❌ No disabled tests without explicit follow-up in task docs
   Fix or track broken tests
...
```
❌ No @ts-ignore or @ts-expect-error without explicit follow-up in task docs
   Fix type issues properly

❌ No any types without justification
   Use proper typing

❌ No .skip() on tests without explicit follow-up in task docs
   Fix or track broken tests
...
```
❌ No TODOs or FIXMEs without explicit follow-up in task docs
   Track work in task docs, not in code comments
...
❌ No "we'll do this later"
   Either do it now or add an explicit follow-up in task docs
```
...
❌ No deprecation markers without timeline
   Either remove now or add a dated follow-up in task docs
   - @deprecated without action = "keep forever"
   - Every @deprecated needs a tracked removal plan
